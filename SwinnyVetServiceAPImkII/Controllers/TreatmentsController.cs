...
namespace SwinnyVetServiceAPImkII.Controllers
{
    public class TreatmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TreatmentID,Name,OwnerID,ProcedureID,Date,Notes,Price")] Treatment treatment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TreatmentID,Name,OwnerID,ProcedureID,Date,Notes,Price")] Treatment treatment)
        {
            if (ModelState.IsValid)
            {
